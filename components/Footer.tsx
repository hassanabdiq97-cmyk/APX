...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#020617] pt-20 pb-10 border-t border-white/5 text-sm font-light text-slate-400">
       <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
             ...
             <div className="col-span-1 md:col-span-1">
                <div className="flex items-center gap-3 mb-6">
                   ...
                   <span className="font-bold text-white tracking-widest uppercase">APEX Industrial</span>
                </div>
                <p className="text-slate-500 text-xs leading-relaxed mb-6">
                   {t.footer.brand_desc}
                </p>
                <div className="flex gap-4">
                   <div className="p-2 bg-white/5 rounded border border-white/5" title="ISO 9001 Compliant Process">
                      <Award size={20} className="text-slate-300" />
                   </div>
                   <div className="p-2 bg-white/5 rounded border border-white/5" title="SUVA Safety Standards">
             ...
             {/* Services Links */}
             <div>
                <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-6">{t.footer.services_title}</h4>
             ...
             {/* Region Links */}
             <div>
                <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-6">{t.footer.region_title}</h4>
                <ul className="space-y-3 text-xs">
             ...
             {/* Contact Info */}
             <div>
                <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-6">{t.footer.contact_title}</h4>
                <div className="space-y-4">
                   <div className="flex items-start gap-3">
                      <MapPin size={16} className="text-safety mt-0.5 shrink-0" />
                      <div>
                         <span className="block text-white font-medium">APEX Industrial Solutions</span>
                   ...
                   <div className="flex items-center gap-3">
                      ...
                      <a href="tel:+41321234567" className="hover:text-white transition-colors">+41 32 123 45 67</a>
                   </div>
                   <div className="flex items-center gap-3">
                      <Mail size={16} className="text-safety shrink-0" />
                      <a href="mailto:service@apex-swiss.ch" className="hover:text-white transition-colors">service@apex-swiss.ch</a>
                   </div>
                   <div className="pt-4">
                      <Button size="sm" variant="outline" fullWidth onClick={() => document.getElementById('kontakt')?.scrollIntoView({behavior: 'smooth'})}>
                         {t.footer.callback}
                      </Button>
                   </div>
                </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-[10px] text-slate-600 font-mono uppercase tracking-wider">
